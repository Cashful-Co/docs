...
For a guided walkthrough, see the tutorial: [Onboard a Merchant](../tutorials/merchant-onboarding.mdx)
...
1. Follow the `Onboard a Merchant` tutorial to get your first integration running.
...
- Create a Checkout Session — [Create a Checkout Session](../tutorials/create-a-checkout-session.mdx)
- Manage Customers — [Manage Customers](../tutorials/manage-customers.mdx)
